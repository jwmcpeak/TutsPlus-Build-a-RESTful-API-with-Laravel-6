...
class InstrumentService extends ResourceService {
    ...
    public function patch($instrument, $payload) {
        ...
        return $this->update($instrument, $payload);
    }

    public function put($instrument, $payload) {
        $this->validateAll($payload);

        return $this->update($instrument, $payload);
    }

    private function update($instrument, $payload) {
    ...
    private function validateAll($payload) {
        \Validator::make($payload, [
            ...
            'status' => 'present|string|nullable',
            'orderId' => 'present|integer|nullable'
        ])->validate();
    }
